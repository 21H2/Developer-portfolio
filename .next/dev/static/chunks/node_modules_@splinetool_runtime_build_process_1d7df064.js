...
"[project]/node_modules/@splinetool/runtime/build/process.js [client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
    ...
    return function(moduleArg = {}) {
        ...
        var __embind_register_class_property = (classType, fieldName, getterReturnType, getterSignature, getter, getterContext, setterArgumentType, setterSignature, setter, setterContext)=>{
            ...
            whenDependentTypesAreResolved([], [
                ...
                if (setter) {
                    desc.set = ()=>throwUnboundTypeError(`Cannot access ${humanName} due to unbound types`, [
                            getterReturnType,
                            setterArgumentType
                        ]);
                } else {
...
//# sourceMappingURL=node_modules_%40splinetool_runtime_build_process_1d7df064.js.map